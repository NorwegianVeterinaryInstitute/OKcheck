...
#'     Defaults to "check_ok_PJSdata.Rmd" in the \code{OKplan}.
...
#' @param aar \[\code{numeric(1)}\]. The year for which the
#'     selection is planned. Defaults to previous year.
#' @param accept \[\code{character(1)}\]. How strict should the check of code
#'     combinations be. Defaults to "accept_always", i.e. the most strict check.
