...
env <- environment()
heading_info <- subset(heading_for_check_tables, 
                       heading_for_check_tables$purpose == get('purpose',env) & 
                         heading_for_check_tables$variable_combination == paste(code_variable, collapse = "-"))
if (dim(heading_info)[1] == 0) {
  heading_info <- subset(heading_for_check_tables, 
                         heading_for_check_tables$purpose == "general" & 
                           heading_for_check_tables$variable_combination == paste(code_variable, collapse = "-"))
}
